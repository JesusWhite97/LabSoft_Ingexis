<?php
    ...
    session_start();
    //=========================================================================
    function imprimir_tarjetas_obras($texto){
        // $cliente = new Cliente();
        ...
        // for($i = 0; $i<count($arrayTajetas); $i++){
            $Tarjetas = $Tarjetas . '
                        <div id="'. "*IDObra*" .'" class="contenedorTarjetaUsuario" onclick=cargarInfoC("'."*IDObra*".'")>
                            <div id="desenfoque" class="sombra"></div>
                            <a>
                                <h2 class="tituloTarjetaUsuario"> '."TituloObra".' </h2>
                                <h3 class="subtituloTarjetaUsuario">'."Cliente".'</h3>
                            </a>
                        </div>
                        ';
        // }
